...
class Preprocess(object):
    ...
    def generate_features_for_inference(self,df_essays,is_inference):
        try:
            ...
            # =============================================================================
            df_psyco_essays = self.apply_empath_analysis(df_semantic_essays)
